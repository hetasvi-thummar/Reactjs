...
const Events = () => {
    ...
    // const title = events.filter(event => event.title === 'Cirque du Soleil: Alegria - Chicago');
    // console.log(title);

    return (
        <>
            <div className="container-md  mt-5">
                <div className="row pl-5 "><h5>Upcoming Events</h5></div>
                ...
                <div className="row mt-5">
                            ...
                            <div key={event.id}>
                                <div className="row  p-2 m-2 event-div">
                                    <div className="col-sm-3">
                                        <div className="event-title">{moment(event.datetime_utc).format('MMM D')}</div>
                                        <div className="event-subtitle">{moment(event.datetime_utc).format('ddd hh:mm a')}</div>
                                    </div>
                                    <div className="col-sm-7">
                                        <div className="event-title">{event.title}</div>
                                        <div className="event-subtitle">{event.venue.name}-{event.venue.display_location}</div>
                                    </div>

                                    <div className="col-sm-2"><Button color="primary" className="button">
                                        {event.stats.lowest_price !== null ? event.stats.lowest_price : "Track"}
                                    </Button>
                    ...
                    <div className="col-sm-4 pl-5">
                        <div className="row">
                            <Card className="card">
                                <CardBody>
                                    <CardTitle className="mb-3"><h6>Buyer Guarantee <br></br>We will make it right</h6></CardTitle>
                                    <CardSubtitle className="card-subtitle"><FontAwesomeIcon icon={faCheck} className="pr-2 iconright" />Canceled events refunded</CardSubtitle>
                        ...
                        <div className="row p-4">
                            <Card className="text-center p-2">
                                ...
                                <CardImgOverlay>
                                    <CardBody>
                                        <CardTitle className="text-white">Get Upcoming Events updates and discover similar events.</CardTitle>
